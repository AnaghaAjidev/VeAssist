                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <p className="mt-8 text-lg text-gray-600 leading-8">
                            ...
                            greater ease and confidence. It brings together guidance,
                            document management, application tracking, and officer support
                        ...
                        <p className="mt-6 text-lg text-gray-600 leading-8">
                            ...
                            By simplifying complex procedures and providing a structured
                            workflow, VeAssist helps families stay informed, organized,
                            and connected throughout every stage of the assistance process.
